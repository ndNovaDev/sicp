...
(dn (=zero? (make-scheme-number 0)))
(dn (=zero? (make-scheme-number 10086)))
(dn (=zero? (make-rational 0 1)))
(dn (=zero? (make-rational 10086 10086)))
(dn (=zero? (make-complex-from-real-imag 0 0)))
