...
(define pa (segments->painter (list (make-segment (make-vect 0.0 0.0) (make-vect 0.1 0.0))
                                    (make-segment (make-vect 0.1 0.0) (make-vect 0.1 0.1))
                                    (make-segment (make-vect 0.1 0.1) (make-vect 0.0 0.1))
                                    (make-segment (make-vect 0.0 0.1) (make-vect 0.0 0.0))
                                    (make-segment (make-vect 0.0 0.0) (make-vect 0.3 0.0))
                                    (make-segment (make-vect 0.3 0.0) (make-vect 0.3 0.3))
                                    (make-segment (make-vect 0.3 0.3) (make-vect 0.0 0.3))
                                    (make-segment (make-vect 0.0 0.3) (make-vect 0.0 0.0))
                                    )))
