...
(define p1 (make-polynomial 'x (list (make-term 7 em) (make-term 5 123) (make-term 2 1))))
(define p2 (make-polynomial 'x (list (make-term 8 em) (make-term 5 123) (make-term 0 3))))
